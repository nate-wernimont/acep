...
public class Spec extends Benchmark {
	
	private static String _config = "/home/ganeshau/benchmarks/specjvm/";
	private StaticProfilePassImpl spp;
	private CallGraphDFS dfs;
	//private SootMethod main;
	
	public Spec (String benchmark) {
		super(_config + benchmark + ".xml");
		prepareSoot();
		//display();
	}
