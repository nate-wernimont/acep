...
public class ParallelTest {
	...
	public static void prepare (String [] args) {
		...
		String b = args[0];
		if (b.equalsIgnoreCase("series")) {
			mainClass = "JGFSeriesBenchSizeA";
			incs.add("series");
		} else if (b.equalsIgnoreCase("lufact")) {
			mainClass = "JGFLUFactBenchSizeA";
			incs.add("lufact");
		} else if (b.equalsIgnoreCase("sor")) {
			mainClass = "JGFSORBenchSizeA";
			incs.add("sor");
		} else if (b.equalsIgnoreCase("crypt")) {
			mainClass = "JGFCryptBenchSizeA";
			incs.add("crypt");
		} else if (b.equalsIgnoreCase("sparse")) {
			mainClass = "JGFSparseMatmultBenchSizeA";
			incs.add("sparsematmult");
		} else if (b.equalsIgnoreCase("moldyn")) {
			//return;
			mainClass = "JGFMolDynBenchSizeA";
			incs.add("moldyn");
		} else if (b.equalsIgnoreCase("montecarlo")) {
			//return;
			mainClass = "MonteCarloTestMain";//"JGFMonteCarloBenchSizeA";
			incs.add("montecarlo");
		} else if (b.equalsIgnoreCase("raytracer")) {
			//return;
